...
Repo: https://github.com/sanskruti737/ZKEventAccess

## a) Discord / Telegram message (under 100 words)

Testing a privacy dApp on Midnight Preprod and need beta users!
...
Demo: https://zkevent-access.vercel.app
Addresses/feedback: DM me here.

## b) X post (under 280 characters)

Test my Midnight dApp on Preprod: ZK Event Access lets organizers issue event credentials via zero-knowledge proofs. The public count is fully auditable; who holds each credential stays private.

Try it: https://zkevent-access.vercel.app
...
It takes about 2 minutes and your feedback would genuinely help. Happy to walk you through it live if useful. Thanks!